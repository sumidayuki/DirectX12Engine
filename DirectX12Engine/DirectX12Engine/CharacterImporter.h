...
public:
	/// <summary>
	/// Assets/Json/Characters/の全てのJSONファイルを読み込み、
	/// CharacterInfoRegistryに登録します。
	/// </summary>
	void Import();
...
private:
	...
	void ProcessTransitions(const Json& json, MoveData& move);
	void ProcessTransition(const Json& json, MoveTransition& transition);
