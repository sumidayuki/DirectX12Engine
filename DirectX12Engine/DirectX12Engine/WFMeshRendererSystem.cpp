...
void WFMeshRendererSystem::StaticConstructor()
{
...
void WFMeshRendererSystem::StaticDestructor()
{
    // リングバッファのマップを解除
...
D3D12_GPU_DESCRIPTOR_HANDLE WFMeshRendererSystem::GetSRV(Texture2D* tex, DescriptorAllocator* allocator)
{
...
void WFMeshRendererSystem::Start(World& world)
{
...
void WFMeshRendererSystem::Draw(World& world)
{
    // グラフィックスパイプラインの設定
    ...
    // 描画対象のエンティティを取得
    View<Transform, MeshFilter, WFMeshRenderer> view(world);
